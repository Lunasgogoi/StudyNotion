...
const CourseCard = ({ cardData }) => {
  return (
    <div className="flex h-full min-h-[300px] w-full min-w-0 cursor-pointer flex-col justify-between rounded-lg bg-richblack-800 p-6 text-richblack-25 shadow-[0px_10px_20px_rgba(0,0,0,0.4)] transition-all duration-200 hover:scale-[1.03] hover:shadow-[0px_10px_40px_rgba(8,217,214,0.15)]">
